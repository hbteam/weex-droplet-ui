...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-droplet-ui/example/actionsheet/index"] = factory();
	else
		root["npm/weex-droplet-ui/example/actionsheet/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/actionsheet/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ff5956ca", Component.options)
  } else {
    hotAPI.reload("data-v-ff5956ca", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
    components: {
        WxActionsheet: _index.WxActionsheet,
    ...
    methods: {
        ...
        callPhone: function callPhone(action) {
            modal.toast({ message: action.name });
        },
        takeMobile: function takeMobile(action) {
            modal.toast({ message: action.name });
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('wx-button', {
  ...
  }, [_vm._v("不带取消按钮")]), _vm._v(" "), _c('wx-button', {
    staticClass: "button",
    attrs: {
      "width": "600px",
      "textFontSize": "32px",
  ...
  }, [_vm._v("点击空白处不关闭")]), _vm._v(" "), _c('wx-actionsheet', {
    attrs: {
    ...
    model: {
      value: (_vm.showSheet1),
      callback: function($$v) {
        _vm.showSheet1 = $$v
      },
      expression: "showSheet1"
    }
  }), _vm._v(" "), _c('wx-actionsheet', {
    attrs: {
    ...
    model: {
      value: (_vm.showSheet2),
      callback: function($$v) {
        _vm.showSheet2 = $$v
      },
      expression: "showSheet2"
    }
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ff5956ca", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("19991f03", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ff5956ca\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ff5956ca\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
