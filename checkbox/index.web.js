...
exports.default = {
    components: {
        ...
        WxCheckboxList: _index.WxCheckboxList
    },
    data: function data() {
        return {
            checked: false,
...
// module
exports.push([module.i, "\n.wx-demo[data-v-8b8532b2] {\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: column;\n            flex-direction: column;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n            align-items: center;\n}\n.title[data-v-8b8532b2] {\n    width: 10rem;\n    height: 1.33333rem;\n    line-height: 1.33333rem;\n    text-align: center;\n    border-bottom-width: 1px;\n    border-bottom-style: solid;\n    border-bottom-color: #DCDCDC;\n    background-color: #027FF3;\n    color: #fff;\n}\n.result[data-v-8b8532b2] {\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: row;\n            flex-direction: row;\n    -webkit-box-pack: center;\n    -webkit-justify-content: center;\n            justify-content: center;\n    margin: 0.53333rem;\n}\n", "", {"version":3,"sources":["/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/checkbox/index.vue?6fea413e"],"names":[],"mappings":";AA8GA;IACA,6BAAA;IAAA,8BAAA;IAAA,+BAAA;YAAA,uBAAA;IACA,0BAAA;IAAA,4BAAA;YAAA,oBAAA;CACA;AAEA;IACA,aAAA;IACA,mBAAA;IACA,wBAAA;IACA,mBAAA;IACA,yBAAA;IACA,2BAAA;IACA,6BAAA;IACA,0BAAA;IACA,YAAA;CACA;AAEA;IACA,+BAAA;IAAA,8BAAA;IAAA,4BAAA;YAAA,oBAAA;IACA,yBAAA;IAAA,gCAAA;YAAA,wBAAA;IACA,mBAAA;CACA","file":"index.vue","sourcesContent":["<template>\n    <div class=\"wx-demo\">\n        <text class=\"title\">checkbox</text>\n        <wx-cell \n            text=\"爱看电影\"\n            icon=\"\"\n            height=\"100px\"\n            width=\"690px\"\n            textColor=\"#333\"\n            textFontSize=\"32px\"\n            :hasArrow=\"false\"\n            @wxClick=\"handleClick\">\n                <wx-checkbox \n                    slot=\"right\"\n                    text=\"\" \n                    v-model=\"checked\"\n                    checkedColor=\"#027FF3\"\n                    align=\"left\"\n                    :disabled=\"false\"\n                    @wxChange=\"handleChange\">\n                </wx-checkbox>\n            </wx-cell>\n            <wx-cell \n                text=\"\"\n                icon=\"\"\n                height=\"100px\"\n                width=\"690px\"\n                textColor=\"#333\"\n                textFontSize=\"32px\"\n                :hasArrow=\"false\">\n                    <wx-checkbox \n                        slot=\"right\"\n                        text=\"爱看小说\" \n                        v-model=\"checked2\"\n                        checkedColor=\"#027FF3\"\n                        align=\"left\"\n                        :disabled=\"false\"\n                        @wxChange=\"handleChange\">\n                    </wx-checkbox>\n            </wx-cell>\n            <wx-cell \n                text=\"\"\n                icon=\"\"\n                height=\"100px\"\n                width=\"690px\"\n                textColor=\"#333\"\n                textFontSize=\"32px\"\n                :hasArrow=\"false\">\n                    <wx-checkbox \n                        slot=\"right\"\n                        text=\"爱看小说\" \n                        v-model=\"checked3\"\n                        checkedColor=\"#027FF3\"\n                        align=\"right\"\n                        :disabled=\"false\"\n                        @wxChange=\"handleChange\">\n                    </wx-checkbox>\n            </wx-cell>\n            <wx-cell \n                text=\"\"\n                icon=\"\"\n                height=\"100px\"\n                width=\"690px\"\n                textColor=\"#333\"\n                textFontSize=\"32px\"\n                :hasArrow=\"false\">\n                    <wx-checkbox \n                        slot=\"right\"\n                        text=\"disabled checked\" \n                        v-model=\"checked4\"\n                        checkedColor=\"#027FF3\"\n                        align=\"left\"\n                        :disabled=\"true\"\n                        @wxChange=\"handleChange\">\n                    </wx-checkbox>\n            </wx-cell>\n            <wx-cell \n                text=\"\"\n                icon=\"\"\n                height=\"100px\"\n                width=\"690px\"\n                textColor=\"#333\"\n                textFontSize=\"32px\"\n                :hasArrow=\"false\">\n                    <wx-checkbox \n                        slot=\"right\"\n                        text=\"disabled\" \n                        v-model=\"checked5\"\n                        checkedColor=\"#027FF3\"\n                        align=\"left\"\n                        :disabled=\"true\"\n                        @wxChange=\"handleChange\">\n                    </wx-checkbox>\n            </wx-cell>\n        <text class=\"title\">checkbox-list</text>\n        <wx-checkbox-list \n            v-model=\"list\"\n            :options=\"options\"\n            width=\"750px\"\n            height=\"100px\"\n            padding=\"20px\"\n            checkedColor=\"red\"\n            @wxChange=\"handleChange\">\n        </wx-checkbox-list>\n        <div class=\"result\">\n            <text>[{{ list.join() }}]</text>\n        </div>\n    </div>\n</template>\n<style type=\"text/css\" scoped>\n    .wx-demo {\n        flex-direction: column;\n        align-items: center;\n    }\n\n    .title {\n        width: 750px;\n        height: 100px;\n        line-height: 100px;\n        text-align: center;\n        border-bottom-width: 1px;\n        border-bottom-style: solid;\n        border-bottom-color: #DCDCDC;\n        background-color: #027FF3;\n        color: #fff;\n    }\n\n    .result {\n        flex-direction: row;\n        justify-content: center;\n        margin: 40px;\n    }\n</style>\n<script>\n    import { WxCheckbox, WxCell, WxCheckboxList } from '../../index';\n    const modal = weex.requireModule('modal');\n    export default {\n        components: {\n            WxCheckbox,\n            WxCell,\n            WxCheckboxList,\n        },\n        data () {\n            return {\n                 checked: false,\n                 checked2: true,\n                 checked3: false,\n                 checked4: true,\n                 checked5: false,\n                 options: [\n                    { title: '爱看电影', value: 1, checked: false, disabled: true },\n                    { title: '爱看小说', value: 2, checked: true },\n                    { title: '爱看抖音', value: 3, checked: false },\n                    { title: '爱刷微博', value: 4, checked: true }\n                 ],\n                 list: [],\n            }\n        },\n        created () {\n\n        },\n        methods: {\n            handleClick () {\n                // 第一个例子使用\n                this.checked = !this.checked;\n            },\n            handleChange (checkedListValue) {\n                console.log(checkedListValue)\n            },\n        }\n    }\n</script>\n"],"sourceRoot":""}]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title weex-el weex-text",
    attrs: {}
  }, [_vm._v("checkbox")]), _vm._v(" "), _c('wx-cell', {
    attrs: {
      "text": "爱看电影",
      "icon": "",
      "height": "100px",
    ...
    staticClass: "title weex-el weex-text",
    attrs: {}
  }, [_vm._v("checkbox-list")]), _vm._v(" "), _c('wx-checkbox-list', {
    attrs: {
      "options": _vm.options,
      "width": "750px",
      "height": "100px",
    ...
    staticClass: "result weex-ct",
    attrs: {}
  }, [_c('p', [_vm._v("[" + _vm._s(_vm.list.join()) + "]")])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4e37ef4d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8b8532b2\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8b8532b2\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
