...
var YEARS = exports.YEARS = {
    ...
    displayValue: function displayValue(y) {
        return y;
    }
};
...
var MONTHS = exports.MONTHS = {
    ...
    displayValue: function displayValue(m) {
        return m;
    }
};
...
var getMaxDay = exports.getMaxDay = function getMaxDay(y, m) {
...
var _pickerDate = __webpack_require__(234);
...
exports.default = {
    ...
    components: {
        WxPicker: _index.WxPicker,
        WxButton: _index.WxButton,
        WxPopup: _index.WxPopup,
        Picker3: _picker2.default,
...
exports.default = {
    ...
    created: function created() {
        this.selectedDate = [_data.YEARS.defaultValue, _data.MONTHS.defaultValue, this.days.defaultValue];
        this.formate();
    },
    ...
    methods: {
        ...
        changeYear: function changeYear(y) {
            this.selectedDate[0] = y;
            this.formate();
        },
        changeMonth: function changeMonth(m) {
            this.selectedDate[1] = m;
            var currentMonth = new Date().getMonth() + 1;
            var selectedDay = this.selectedDate[2];
            var maxDay = (0, _data.getMaxDay)(this.selectedDate[0], m);
            var d = selectedDay;
        ...
        changeDay: function changeDay(d) {
            this.selectedDate[2] = d;
            this.formate();
        },
        formate: function formate() {
...
// module
exports.push([module.i, "\n.wx-demo[data-v-51484d2d] {\n}\n.field[data-v-51484d2d] {\n    margin-left: 0.4rem;\n}\n.btn-wrap[data-v-51484d2d] {\n    background-color: #ccc;\n    height: 1.17333rem;\n    font-size: 0.50667rem;\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: row;\n            flex-direction: row;\n    -webkit-box-pack: justify;\n    -webkit-justify-content: space-between;\n            justify-content: space-between;\n    -webkit-box-align: center;\n    -webkit-align-items: center;\n            align-items: center;\n}\n.btn[data-v-51484d2d] {\n    line-height: 1.17333rem;\n    height: 1.17333rem;\n    width: 1.33333rem;\n    text-align: center;\n    color: #007aff;\n    font-size: 0.42667rem;\n}\n.flex[data-v-51484d2d] {\n    -webkit-box-orient: horizontal;\n    -webkit-box-direction: normal;\n    -webkit-flex-direction: row;\n            flex-direction: row;\n}\n.flex-1[data-v-51484d2d] {\n    -webkit-box-flex: 1;\n    -webkit-flex: 1;\n            flex: 1;\n}\n", "", {"version":3,"sources":["/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/picker/picker-date.vue?5834e3aa"],"names":[],"mappings":";AAqCA;CACA;AAEA;IACA,oBAAA;CACA;AAEA;IACA,uBAAA;IACA,mBAAA;IACA,sBAAA;IACA,+BAAA;IAAA,8BAAA;IAAA,4BAAA;YAAA,oBAAA;IACA,0BAAA;IAAA,uCAAA;YAAA,+BAAA;IACA,0BAAA;IAAA,4BAAA;YAAA,oBAAA;CACA;AAEA;IACA,wBAAA;IACA,mBAAA;IACA,kBAAA;IACA,mBAAA;IACA,eAAA;IACA,sBAAA;CACA;AAEA;IACA,+BAAA;IAAA,8BAAA;IAAA,4BAAA;YAAA,oBAAA;CACA;AAEA;IACA,oBAAA;IAAA,gBAAA;YAAA,QAAA;CACA","file":"picker-date.vue","sourcesContent":["<template>\n    <div class=\"wx-demo\">\n        <wx-field\n            label=\"日期\"\n            labelPosition=\"top\"\n            placeholder=\"请选择日期\"\n            width=\"690px\"\n            class=\"field\"\n            :disabled=\"true\"\n            :hasArrow=\"true\"\n            @wxClick=\"visibleDate=true\"\n            v-model=\"selectedDateStr\"\n            height=\"200px\">\n        </wx-field>\n\n        <wx-popup \n            :visible=\"visibleDate\" \n            position=\"bottom\" \n            :hasOverley=\"true\"\n            height=\"488px\"\n            ref=\"popupDate\"\n            @wxChange=\"showYears\">\n            <div>\n                <div class=\"btn-wrap\">\n                    <text class=\"btn\" @click=\"handleCancel('popupDate')\">取消</text>\n                    <text class=\"btn\" @click=\"handleFinish('popupDate')\">完成</text>\n                </div>\n                <div class=\"flex\">\n                    <wx-picker :data=\"years\" :visible=\"visibleDate\" @wxChange=\"changeYear\" class=\"flex-1\"></wx-picker>\n                    <wx-picker :data=\"months\" :visible=\"visibleDate\" @wxChange=\"changeMonth\" class=\"flex-1\"></wx-picker>\n                    <wx-picker :data=\"days\" :visible=\"visibleDate\" @wxChange=\"changeDay\" class=\"flex-1\"></wx-picker>\n                </div>\n            </div>\n        </wx-popup>\n    </div>\n</template>\n<style scoped>\n    .wx-demo {\n    }\n\n    .field {\n        margin-left: 30px;\n    }\n\n    .btn-wrap {\n        background-color: #ccc;\n        height: 88px;\n        font-size: 38px;\n        flex-direction: row;\n        justify-content: space-between;\n        align-items: center;\n    }\n\n    .btn {\n        line-height: 88px;\n        height: 88px;\n        width: 100px;\n        text-align: center;\n        color: #007aff;\n        font-size: 32px;\n    }\n\n    .flex {\n        flex-direction: row;\n    }\n\n    .flex-1 {\n        flex: 1;\n    }\n</style>\n<script>\n    import { WxPicker, WxButton, WxPopup, WxField } from '../../index';\n    import { YEARS, MONTHS, getDays, getMaxDay } from './data';\n    export default {\n        data () {\n            return {\n                years: YEARS,\n                months: MONTHS,\n                days: getDays(),\n                visibleDate: false,\n                selectedDate: [],\n                selectedDateStr: [],\n\n            }\n        },\n\n        created () {\n            this.selectedDate = [YEARS.defaultValue, MONTHS.defaultValue, this.days.defaultValue];\n            this.formate();\n        },\n\n        methods: {\n            handleCancel (ref) {\n                this.$refs[ref].hide();\n            },\n\n            handleFinish (ref) {\n                this.$refs[ref].hide();\n            },\n\n            showYears (visible) {\n                this.visibleDate = visible;\n            },\n\n            changeYear (y) {\n                this.selectedDate[0] = y;\n                this.formate();\n            },\n\n            changeMonth (m) {\n                this.selectedDate[1] = m;\n                let currentMonth = new Date().getMonth() + 1;\n                let selectedDay = this.selectedDate[2];\n                let maxDay = getMaxDay(this.selectedDate[0], m);\n                let d = selectedDay;\n                if (selectedDay > maxDay) {\n                    d = maxDay;\n                }\n                this.days = getDays(this.selectedDate[0], m, d);\n                this.formate();\n            },\n\n            changeDay (d) {\n                this.selectedDate[2] = d;\n                this.formate();\n            },\n\n            formate () {\n                this.selectedDateStr = this.selectedDate.join('-');\n            },\n        },\n        components: { \n            WxPicker, \n            WxButton, \n            WxPopup, \n            WxField \n        }\n    }\n</script>\n"],"sourceRoot":""}]);
...
Component.options.__file = "/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/picker/picker-date.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] picker-date.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-51484d2d", Component.options)
  } else {
    hotAPI.reload("data-v-51484d2d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1), _vm._v(" "), _c('PickerDate'), _vm._v(" "), _c('wx-popup', {
    ref: "popupYears",
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-51484d2d", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("0fb56cc6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-51484d2d\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./picker-date.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-51484d2d\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./picker-date.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
