...
var _is = __webpack_require__(71);
...
var areas = exports.areas = (_areas = {
...
}, _defineProperty(_areas, '\u54C8\u5C14\u6EE8\u5E02', ['龙沙区', '建华区', '铁锋区', '昂昂溪区', '富拉尔基区', '碾子山区', '梅里斯达斡尔族区', '龙江县', '依安县', '泰来县', '甘南县', '富裕县', '克山县', '克东县', '拜泉县', '讷河市']), _defineProperty(_areas, '鸡西市', ['鸡冠区', '恒山区', '滴道区', '梨树区', '城子河区', '麻山区', '鸡东县', '虎林市', '密山市']), _defineProperty(_areas, '鹤岗市', ['向阳区', '工农区', '南山区', '兴安区', '东山区', '兴山区', '萝北县', '绥滨县']), _defineProperty(_areas, '双鸭山市', ['尖山区', '岭东区', '四方台区', '宝山区', '集贤县', '友谊县', '宝清县', '饶河县']), _defineProperty(_areas, '大庆市', ['萨尔图区', '龙凤区', '让胡路区', '红岗区', '大同区', '肇州县', '肇源县', '林甸县', '杜尔伯特蒙古族自治县']), _defineProperty(_areas, '伊春市', ['伊春区', '南岔区', '友好区', '西林区', '翠峦区', '新青区', '美溪区', '金山屯区', '五营区', '乌马河区', '汤旺河区', '带岭区', '乌伊岭区', '红星区', '上甘岭区', '嘉荫县', '铁力市']), _defineProperty(_areas, '佳木斯市', ['向阳区', '前进区', '东风区', '郊区', '桦南县', '桦川县', '汤原县', '抚远县', '同江市', '富锦市']), _defineProperty(_areas, '七台河市', ['新兴区', '桃山区', '茄子河区', '勃利县']), _defineProperty(_areas, '牡丹江市', ['东安区', '阳明区', '爱民区', '西安区', '东宁县', '林口县', '绥芬河市', '海林市', '宁安市', '穆棱市']), _defineProperty(_areas, '黑河市', ['爱辉区', '嫩江县', '逊克县', '孙吴县', '北安市', '五大连池市']), _defineProperty(_areas, '绥化市', ['北林区', '望奎县', '兰西县', '青冈县', '庆安县', '明水县', '绥棱县', '安达市', '肇东市', '海伦市']), _defineProperty(_areas, '大兴安岭地区', ['加格达奇区', '松岭区', '新林区', '呼中区', '呼玛县', '塔河县', '漠河县']), _defineProperty(_areas, '上海市', ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '南汇区', '奉贤区', '崇明县']), _defineProperty(_areas, '南京市', ['玄武区', '白下区', '秦淮区', '建邺区', '鼓楼区', '下关区', '浦口区', '栖霞区', '雨花台区', '江宁区', '六合区', '溧水县', '高淳县']), _defineProperty(_areas, '无锡市', ['崇安区', '南长区', '北塘区', '锡山区', '惠山区', '滨湖区', '江阴市', '宜兴市']), _defineProperty(_areas, '徐州市', ['鼓楼区', '云龙区', '九里区', '贾汪区', '泉山区', '丰县', '沛县', '铜山县', '睢宁县', '新沂市', '邳州市']), _defineProperty(_areas, '常州市', ['天宁区', '钟楼区', '戚墅堰区', '新北区', '武进区', '溧阳市', '金坛市']), _defineProperty(_areas, '苏州市', ['沧浪区', '平江区', '金阊区', '虎丘区', '吴中区', '相城区', '常熟市', '张家港市', '昆山市', '吴江市', '太仓市']), _defineProperty(_areas, '南通市', ['崇川区', '港闸区', '海安县', '如东县', '启东市', '如皋市', '通州市', '海门市']), _defineProperty(_areas, '连云港市', ['连云区', '新浦区', '海州区', '赣榆县', '东海县', '灌云县', '灌南县']), _defineProperty(_areas, '淮安市', ['清河区', '楚州区', '淮阴区', '清浦区', '涟水县', '洪泽县', '盱眙县', '金湖县']), _defineProperty(_areas, '盐城市', ['亭湖区', '盐都区', '响水县', '滨海县', '阜宁县', '射阳县', '建湖县', '东台市', '大丰市']), _defineProperty(_areas, '扬州市', ['广陵区', '邗江区', '维扬区', '宝应县', '仪征市', '高邮市', '江都市']), _defineProperty(_areas, '镇江市', ['京口区', '润州区', '丹徒区', '丹阳市', '扬中市', '句容市']), _defineProperty(_areas, '泰州市', ['海陵区', '高港区', '兴化市', '靖江市', '泰兴市', '姜堰市']), _defineProperty(_areas, '宿迁市', ['宿城区', '宿豫区', '沭阳县', '泗阳县', '泗洪县']), _defineProperty(_areas, '杭州市', ['上城区', '下城区', '江干区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '桐庐县', '淳安县', '建德市', '富阳市', '临安市']), _defineProperty(_areas, '宁波市', ['海曙区', '江东区', '江北区', '北仑区', '镇海区', '鄞州区', '象山县', '宁海县', '余姚市', '慈溪市', '奉化市']), _defineProperty(_areas, '温州市', ['鹿城区', '龙湾区', '瓯海区', '洞头县', '永嘉县', '平阳县', '苍南县', '文成县', '泰顺县', '瑞安市', '乐清市']), _defineProperty(_areas, '嘉兴市', ['秀城区', '秀洲区', '嘉善县', '海盐县', '海宁市', '平湖市', '桐乡市']), _defineProperty(_areas, '湖州市', ['吴兴区', '南浔区', '德清县', '长兴县', '安吉县']), _defineProperty(_areas, '绍兴市', ['越城区', '绍兴县', '新昌县', '诸暨市', '上虞市', '嵊州市']), _defineProperty(_areas, '金华市', ['婺城区', '金东区', '武义县', '浦江县', '磐安县', '兰溪市', '义乌市', '东阳市', '永康市']), _defineProperty(_areas, '衢州市', ['柯城区', '衢江区', '常山县', '开化县', '龙游县', '江山市']), _defineProperty(_areas, '舟山市', ['定海区', '普陀区', '岱山县', '嵊泗县']), _defineProperty(_areas, '台州市', ['椒江区', '黄岩区', '路桥区', '玉环县', '三门县', '天台县', '仙居县', '温岭市', '临海市']), _defineProperty(_areas, '丽水市', ['莲都区', '青田县', '缙云县', '遂昌县', '松阳县', '云和县', '庆元县', '景宁畲族自治县', '龙泉市']), _defineProperty(_areas, '合肥市', ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县']), _defineProperty(_areas, '芜湖市', ['镜湖区', '弋江区', '鸠江区', '三山区', '芜湖县', '繁昌县', '南陵县']), _defineProperty(_areas, '蚌埠市', ['龙子湖区', '蚌山区', '禹会区', '淮上区', '怀远县', '五河县', '固镇县']), _defineProperty(_areas, '淮南市', ['大通区', '田家庵区', '谢家集区', '八公山区', '潘集区', '凤台县']), _defineProperty(_areas, '马鞍山市', ['金家庄区', '花山区', '雨山区', '当涂县']), _defineProperty(_areas, '淮北市', ['杜集区', '相山区', '烈山区', '濉溪县']), _defineProperty(_areas, '铜陵市', ['铜官山区', '狮子山区', '郊区', '铜陵县']), _defineProperty(_areas, '安庆市', ['迎江区', '大观区', '宜秀区', '怀宁县', '枞阳县', '潜山县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市']), _defineProperty(_areas, '黄山市', ['屯溪区', '黄山区', '徽州区', '歙县', '休宁县', '黟县', '祁门县']), _defineProperty(_areas, '滁州市', ['琅琊区', '南谯区', '来安县', '全椒县', '定远县', '凤阳县', '天长市', '明光市']), _defineProperty(_areas, '阜阳市', ['颍州区', '颍东区', '颍泉区', '临泉县', '太和县', '阜南县', '颍上县', '颍上县']), _defineProperty(_areas, '宿州市', ['埇桥区', '砀山县', '萧县', '灵璧县', '泗县']), _defineProperty(_areas, '巢湖市', ['居巢区', '庐江县', '无为县', '含山县', '和县']), _defineProperty(_areas, '六安市', ['金安区', '裕安区', '寿县', '霍邱县', '舒城县', '金寨县', '霍山县']), _defineProperty(_areas, '亳州市', ['谯城区', '涡阳县', '蒙城县', '利辛县']), _defineProperty(_areas, '池州市', ['贵池区', '东至县', '石台县', '青阳县']), _defineProperty(_areas, '宣城市', ['宣州区', '郎溪县', '广德县', '泾县', '绩溪县', '旌德县', '宁国市']), _defineProperty(_areas, '福州市', ['鼓楼区', '台江区', '仓山区', '马尾区', '晋安区', '闽侯县', '连江县', '罗源县', '闽清县', '永泰县', '平潭县', '福清市', '长乐市']), _defineProperty(_areas, '厦门市', ['思明区', '海沧区', '湖里区', '集美区', '同安区', '翔安区']), _defineProperty(_areas, '莆田市', ['城厢区', '涵江区', '荔城区', '秀屿区', '仙游县']), _defineProperty(_areas, '三明市', ['梅列区', '三元区', '明溪县', '清流县', '宁化县', '大田县', '尤溪县', '沙县', '将乐县', '泰宁县', '建宁县', '永安市']), _defineProperty(_areas, '泉州市', ['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '金门县', '石狮市', '晋江市', '南安市']), _defineProperty(_areas, '漳州市', ['芗城区', '龙文区', '云霄县', '漳浦县', '诏安县', '长泰县', '东山县', '南靖县', '平和县', '华安县', '龙海市']), _defineProperty(_areas, '南平市', ['延平区', '顺昌县', '浦城县', '光泽县', '松溪县', '政和县', '邵武市', '武夷山市', '建瓯市', '建阳市']), _defineProperty(_areas, '龙岩市', ['新罗区', '长汀县', '永定县', '上杭县', '武平县', '连城县', '漳平市']), _defineProperty(_areas, '宁德市', ['蕉城区', '霞浦县', '古田县', '屏南县', '寿宁县', '周宁县', '柘荣县', '福安市', '福鼎市']), _defineProperty(_areas, '南昌市', ['东湖区', '西湖区', '青云谱区', '湾里区', '青山湖区', '南昌县', '新建县', '安义县', '进贤县']), _defineProperty(_areas, '景德镇市', ['昌江区', '珠山区', '浮梁县', '乐平市']), _defineProperty(_areas, '萍乡市', ['安源区', '湘东区', '莲花县', '上栗县', '芦溪县']), _defineProperty(_areas, '九江市', ['庐山区', '浔阳区', '九江县', '武宁县', '修水县', '永修县', '德安县', '星子县', '都昌县', '湖口县', '彭泽县', '瑞昌市']), _defineProperty(_areas, '新余市', ['渝水区', '分宜县']), _defineProperty(_areas, '鹰潭市', ['月湖区', '余江县', '贵溪市']), _defineProperty(_areas, '赣州市', ['章贡区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市', '南康市']), _defineProperty(_areas, '吉安市', ['吉州区', '青原区', '吉安县', '吉水县', '峡江县', '新干县', '永丰县', '泰和县', '遂川县', '万安县', '安福县', '永新县', '井冈山市']), _defineProperty(_areas, '宜春市', ['袁州区', '奉新县', '万载县', '上高县', '宜丰县', '靖安县', '铜鼓县', '丰城市', '樟树市', '高安市']), _defineProperty(_areas, '抚州市', ['临川区', '南城县', '黎川县', '南丰县', '崇仁县', '乐安县', '宜黄县', '金溪县', '资溪县', '东乡县', '广昌县']), _defineProperty(_areas, '上饶市', ['信州区', '上饶县', '广丰县', '玉山县', '铅山县', '横峰县', '弋阳县', '余干县', '鄱阳县', '万年县', '婺源县', '德兴市']), _defineProperty(_areas, '济南市', ['历下区', '市中区', '槐荫区', '天桥区', '历城区', '长清区', '平阴县', '济阳县', '商河县', '章丘市']), _defineProperty(_areas, '青岛市', ['市南区', '市北区', '四方区', '黄岛区', '崂山区', '李沧区', '城阳区', '胶州市', '即墨市', '平度市', '胶南市', '莱西市']), _defineProperty(_areas, '淄博市', ['淄川区', '张店区', '博山区', '临淄区', '周村区', '桓台县', '高青县', '沂源县']), _defineProperty(_areas, '枣庄市', ['市中区', '薛城区', '峄城区', '台儿庄区', '山亭区', '滕州市']), _defineProperty(_areas, '东营市', ['东营区', '河口区', '垦利县', '利津县', '广饶县']), _defineProperty(_areas, '烟台市', ['芝罘区', '福山区', '牟平区', '莱山区', '长岛县', '龙口市', '莱阳市', '莱州市', '蓬莱市', '招远市', '栖霞市', '海阳市']), _defineProperty(_areas, '潍坊市', ['潍城区', '寒亭区', '坊子区', '奎文区', '临朐县', '昌乐县', '青州市', '诸城市', '寿光市', '安丘市', '高密市', '昌邑市']), _defineProperty(_areas, '济宁市', ['市中区', '任城区', '微山县', '鱼台县', '金乡县', '嘉祥县', '汶上县', '泗水县', '梁山县', '曲阜市', '兖州市', '邹城市']), _defineProperty(_areas, '泰安市', ['泰山区', '岱岳区', '宁阳县', '东平县', '新泰市', '肥城市']), _defineProperty(_areas, '威海市', ['环翠区', '文登市', '荣成市', '乳山市']), _defineProperty(_areas, '日照市', ['东港区', '岚山区', '五莲县', '莒县']), _defineProperty(_areas, '莱芜市', ['莱城区', '钢城区']), _defineProperty(_areas, '临沂市', ['兰山区', '罗庄区', '河东区', '沂南县', '郯城县', '沂水县', '苍山县', '费县', '平邑县', '莒南县', '蒙阴县', '临沭县']), _defineProperty(_areas, '德州市', ['德城区', '陵县', '宁津县', '庆云县', '临邑县', '齐河县', '平原县', '夏津县', '武城县', '乐陵市', '禹城市']), _defineProperty(_areas, '聊城市', ['东昌府区', '阳谷县', '莘县', '茌平县', '东阿县', '冠县', '高唐县', '临清市']), _defineProperty(_areas, '滨州市', ['滨城区', '惠民县', '阳信县', '无棣县', '沾化县', '博兴县', '邹平县']), _defineProperty(_areas, '菏泽市', ['牡丹区', '曹县', '单县', '成武县', '巨野县', '郓城县', '鄄城县', '定陶县', '东明县']), _defineProperty(_areas, '郑州市', ['中原区', '二七区', '管城回族区', '金水区', '上街区', '惠济区', '中牟县', '巩义市', '荥阳市', '新密市', '新郑市', '登封市']), _defineProperty(_areas, '开封市', ['龙亭区', '顺河回族区', '鼓楼区', '禹王台区', '金明区', '杞县', '通许县', '尉氏县', '开封县', '兰考县']), _defineProperty(_areas, '洛阳市', ['老城区', '西工区', '廛河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市']), _defineProperty(_areas, '平顶山市', ['新华区', '卫东区', '石龙区', '湛河区', '宝丰县', '叶县', '鲁山县', '郏县', '舞钢市', '汝州市']), _defineProperty(_areas, '安阳市', ['文峰区', '北关区', '殷都区', '龙安区', '安阳县', '汤阴县', '滑县', '内黄县', '林州市']), _defineProperty(_areas, '鹤壁市', ['鹤山区', '山城区', '淇滨区', '浚县', '淇县']), _defineProperty(_areas, '新乡市', ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '长垣县', '卫辉市', '辉县市']), _defineProperty(_areas, '焦作市', ['解放区', '中站区', '马村区', '山阳区', '修武县', '博爱县', '武陟县', '温县', '济源市', '沁阳市', '孟州市']), _defineProperty(_areas, '濮阳市', ['华龙区', '清丰县', '南乐县', '范县', '台前县', '濮阳县']), _defineProperty(_areas, '许昌市', ['魏都区', '许昌县', '鄢陵县', '襄城县', '禹州市', '长葛市']), _defineProperty(_areas, '漯河市', ['源汇区', '郾城区', '召陵区', '舞阳县', '临颍县']), _defineProperty(_areas, '三门峡市', ['湖滨区', '渑池县', '陕县', '卢氏县', '义马市', '灵宝市']), _defineProperty(_areas, '南阳市', ['宛城区', '卧龙区', '南召县', '方城县', '西峡县', '镇平县', '内乡县', '淅川县', '社旗县', '唐河县', '新野县', '桐柏县', '邓州市']), _defineProperty(_areas, '商丘市', ['梁园区', '睢阳区', '民权县', '睢县', '宁陵县', '柘城县', '虞城县', '夏邑县', '永城市']), _defineProperty(_areas, '信阳市', ['浉河区', '平桥区', '罗山县', '光山县', '新县', '商城县', '固始县', '潢川县', '淮滨县', '息县']), _defineProperty(_areas, '周口市', ['川汇区', '扶沟县', '西华县', '商水县', '沈丘县', '郸城县', '淮阳县', '太康县', '鹿邑县', '项城市']), _defineProperty(_areas, '驻马店市', ['驿城区', '西平县', '上蔡县', '平舆县', '正阳县', '确山县', '泌阳县', '汝南县', '遂平县', '新蔡县']), _defineProperty(_areas, '武汉市', ['江岸区', '江汉区', '硚口区', '汉阳区', '武昌区', '青山区', '洪山区', '东西湖区', '汉南区', '蔡甸区', '江夏区', '黄陂区', '新洲区']), _defineProperty(_areas, '黄石市', ['黄石港区', '西塞山区', '下陆区', '铁山区', '阳新县', '大冶市']), _defineProperty(_areas, '十堰市', ['茅箭区', '张湾区', '郧县', '郧西县', '竹山县', '竹溪县', '房县', '丹江口市']), _defineProperty(_areas, '宜昌市', ['西陵区', '伍家岗区', '点军区', '猇亭区', '夷陵区', '远安县', '兴山县', '秭归县', '长阳土家族自治县', '五峰土家族自治县', '宜都市', '当阳市', '枝江市']), _defineProperty(_areas, '襄樊市', ['襄城区', '樊城区', '襄阳区', '南漳县', '谷城县', '保康县', '老河口市', '枣阳市', '宜城市']), _defineProperty(_areas, '鄂州市', ['梁子湖区', '华容区', '鄂城区']), _defineProperty(_areas, '荆门市', ['东宝区', '掇刀区', '京山县', '沙洋县', '钟祥市']), _defineProperty(_areas, '孝感市', ['孝南区', '孝昌县', '大悟县', '云梦县', '应城市', '安陆市', '汉川市']), _defineProperty(_areas, '荆州市', ['沙市区', '荆州区', '公安县', '监利县', '江陵县', '石首市', '洪湖市', '松滋市']), _defineProperty(_areas, '黄冈市', ['黄州区', '团风县', '红安县', '罗田县', '英山县', '浠水县', '蕲春县', '黄梅县', '麻城市', '武穴市']), _defineProperty(_areas, '咸宁市', ['咸安区', '嘉鱼县', '通城县', '崇阳县', '通山县', '赤壁市']), _defineProperty(_areas, '随州市', ['曾都区', '广水市']), _defineProperty(_areas, '恩施土家族苗族自治州', ['恩施市', '利川市', '建始县', '巴东县', '宣恩县', '咸丰县', '来凤县', '鹤峰县']), _defineProperty(_areas, '直辖行政单位', ['仙桃市', '潜江市', '天门市', '神农架林区']), _defineProperty(_areas, '长沙市', ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '长沙县', '望城县', '宁乡县', '浏阳市']), _defineProperty(_areas, '株洲市', ['荷塘区', '芦淞区', '石峰区', '天元区', '株洲县', '攸县', '茶陵县', '炎陵县', '醴陵市']), _defineProperty(_areas, '湘潭市', ['雨湖区', '岳塘区', '湘潭县', '湘乡市', '韶山市']), _defineProperty(_areas, '衡阳市', ['珠晖区', '雁峰区', '石鼓区', '蒸湘区', '南岳区', '衡阳县', '衡南县', '衡山县', '衡东县', '祁东县', '耒阳市', '常宁市']), _defineProperty(_areas, '邵阳市', ['双清区', '大祥区', '北塔区', '邵东县', '新邵县', '邵阳县', '隆回县', '洞口县', '绥宁县', '新宁县', '城步苗族自治县', '武冈市']), _defineProperty(_areas, '岳阳市', ['岳阳楼区', '云溪区', '君山区', '岳阳县', '华容县', '湘阴县', '平江县', '汨罗市', '临湘市']), _defineProperty(_areas, '常德市', ['武陵区', '鼎城区', '安乡县', '汉寿县', '澧县', '临澧县', '桃源县', '石门县', '津市市']), _defineProperty(_areas, '张家界市', ['永定区', '武陵源区', '慈利县', '桑植县']), _defineProperty(_areas, '益阳市', ['资阳区', '赫山区', '南县', '桃江县', '安化县', '沅江市']), _defineProperty(_areas, '郴州市', ['北湖区', '苏仙区', '桂阳县', '宜章县', '永兴县', '嘉禾县', '临武县', '汝城县', '桂东县', '安仁县', '资兴市']), _defineProperty(_areas, '永州市', ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县']), _defineProperty(_areas, '怀化市', ['鹤城区', '中方县', '沅陵县', '辰溪县', '溆浦县', '会同县', '麻阳苗族自治县', '新晃侗族自治县', '芷江侗族自治县', '靖州苗族侗族自治县', '通道侗族自治县', '洪江市']), _defineProperty(_areas, '娄底市', ['娄星区', '双峰县', '新化县', '冷水江市', '涟源市']), _defineProperty(_areas, '湘西土家族苗族自治州', ['吉首市', '泸溪县', '凤凰县', '花垣县', '保靖县', '古丈县', '永顺县', '龙山县']), _defineProperty(_areas, '广州市', ['荔湾区', '越秀区', '海珠区', '天河区', '白云区', '黄埔区', '番禺区', '花都区', '南沙区', '萝岗区', '增城市', '从化市']), _defineProperty(_areas, '韶关市', ['武江区', '浈江区', '曲江区', '始兴县', '仁化县', '翁源县', '乳源瑶族自治县', '新丰县', '乐昌市', '南雄市']), _defineProperty(_areas, '深圳市', ['罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '盐田区']), _defineProperty(_areas, '珠海市', ['香洲区', '斗门区', '金湾区']), _defineProperty(_areas, '汕头市', ['龙湖区', '金平区', '濠江区', '潮阳区', '潮南区', '澄海区', '南澳县']), _defineProperty(_areas, '佛山市', ['禅城区', '南海区', '顺德区', '三水区', '高明区']), _defineProperty(_areas, '江门市', ['蓬江区', '江海区', '新会区', '台山市', '开平市', '鹤山市', '恩平市']), _defineProperty(_areas, '湛江市', ['赤坎区', '霞山区', '坡头区', '麻章区', '遂溪县', '徐闻县', '廉江市', '雷州市', '吴川市']), _defineProperty(_areas, '茂名市', ['茂南区', '茂港区', '电白县', '高州市', '化州市', '信宜市']), _defineProperty(_areas, '肇庆市', ['端州区', '鼎湖区', '广宁县', '怀集县', '封开县', '德庆县', '高要市', '四会市']), _defineProperty(_areas, '惠州市', ['惠城区', '惠阳区', '博罗县', '惠东县', '龙门县']), _defineProperty(_areas, '梅州市', ['梅江区', '梅县', '大埔县', '丰顺县', '五华县', '平远县', '蕉岭县', '兴宁市']), _defineProperty(_areas, '汕尾市', ['城区', '海丰县', '陆河县', '陆丰市']), _defineProperty(_areas, '河源市', ['源城区', '紫金县', '龙川县', '连平县', '和平县', '东源县']), _defineProperty(_areas, '阳江市', ['江城区', '阳西县', '阳东县', '阳春市']), _defineProperty(_areas, '清远市', ['清城区', '佛冈县', '阳山县', '连山壮族瑶族自治县', '连南瑶族自治县', '清新县', '英德市', '连州市']), _defineProperty(_areas, '东莞市', ['市辖区']), _defineProperty(_areas, '中山市', ['市辖区']), _defineProperty(_areas, '潮州市', ['湘桥区', '潮安县', '饶平县']), _defineProperty(_areas, '揭阳市', ['榕城区', '揭东县', '揭西县', '惠来县', '普宁市']), _defineProperty(_areas, '云浮市', ['云城区', '新兴县', '郁南县', '云安县', '罗定市']), _defineProperty(_areas, '南宁市', ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '武鸣县', '隆安县', '马山县', '上林县', '宾阳县', '横县']), _defineProperty(_areas, '柳州市', ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江县', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县']), _defineProperty(_areas, '桂林市', ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '阳朔县', '临桂县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县', '平乐县', '荔蒲县', '恭城瑶族自治县']), _defineProperty(_areas, '梧州市', ['万秀区', '蝶山区', '长洲区', '苍梧县', '藤县', '蒙山县', '岑溪市']), _defineProperty(_areas, '北海市', ['海城区', '银海区', '铁山港区', '合浦县']), _defineProperty(_areas, '防城港市', ['港口区', '防城区', '上思县', '东兴市']), _defineProperty(_areas, '钦州市', ['钦南区', '钦北区', '灵山县', '浦北县']), _defineProperty(_areas, '贵港市', ['港北区', '港南区', '覃塘区', '平南县', '桂平市']), _defineProperty(_areas, '玉林市', ['玉州区', '容县', '陆川县', '博白县', '兴业县', '北流市']), _defineProperty(_areas, '百色市', ['右江区', '田阳县', '田东县', '平果县', '德保县', '靖西县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林各族自治县']), _defineProperty(_areas, '贺州市', ['八步区', '昭平县', '钟山县', '富川瑶族自治县']), _defineProperty(_areas, '河池市', ['金城江区', '南丹县', '天峨县', '凤山县', '东兰县', '罗城仫佬族自治县', '环江毛南族自治县', '巴马瑶族自治县', '都安瑶族自治县', '大化瑶族自治县', '宜州市']), _defineProperty(_areas, '来宾市', ['兴宾区', '忻城县', '象州县', '武宣县', '金秀瑶族自治县', '合山市']), _defineProperty(_areas, '崇左市', ['江洲区', '扶绥县', '宁明县', '龙州县', '大新县', '天等县', '凭祥市']), _defineProperty(_areas, '海口市', ['秀英区', '龙华区', '琼山区', '美兰区']), _defineProperty(_areas, '三亚市', ['直辖县级行政单位', '五指山市', '琼海市', '儋州市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县', '西沙群岛', '南沙群岛', '中沙群岛的岛礁及其海域']), _defineProperty(_areas, '市辖区', ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '万盛区', '双桥区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '永川区']), _defineProperty(_areas, '县', ['綦江县', '潼南县', '铜梁县', '大足县', '荣昌县', '璧山县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']), _defineProperty(_areas, '成都市', ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '金堂县', '双流县', '郫县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市']), _defineProperty(_areas, '自贡市', ['自流井区', '贡井区', '大安区', '沿滩区', '荣县', '富顺县']), _defineProperty(_areas, '攀枝花市', ['东区', '西区', '仁和区', '米易县', '盐边县']), _defineProperty(_areas, '泸州市', ['江阳区', '纳溪区', '龙马潭区', '泸县', '合江县', '叙永县', '古蔺县']), _defineProperty(_areas, '德阳市', ['旌阳区', '中江县', '罗江县', '广汉市', '什邡市', '绵竹市']), _defineProperty(_areas, '绵阳市', ['涪城区', '游仙区', '三台县', '盐亭县', '安县', '梓潼县', '北川羌族自治县', '平武县', '江油市']), _defineProperty(_areas, '广元市', ['市中区', '元坝区', '朝天区', '旺苍县', '青川县', '剑阁县', '苍溪县']), _defineProperty(_areas, '遂宁市', ['船山区', '安居区', '蓬溪县', '射洪县', '大英县']), _defineProperty(_areas, '内江市', ['市中区', '东兴区', '威远县', '资中县', '隆昌县']), _defineProperty(_areas, '乐山市', ['市中区', '沙湾区', '五通桥区', '金口河区', '犍为县', '井研县', '夹江县', '沐川县', '峨边彝族自治县', '马边彝族自治县', '峨眉山市']), _defineProperty(_areas, '南充市', ['顺庆区', '高坪区', '嘉陵区', '南部县', '营山县', '蓬安县', '仪陇县', '西充县', '阆中市']), _defineProperty(_areas, '眉山市', ['东坡区', '仁寿县', '彭山县', '洪雅县', '丹棱县', '青神县']), _defineProperty(_areas, '宜宾市', ['翠屏区', '宜宾县', '南溪县', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县']), _defineProperty(_areas, '广安市', ['广安区', '岳池县', '武胜县', '邻水县', '华蓥市']), _defineProperty(_areas, '达州市', ['通川区', '达县', '宣汉县', '开江县', '大竹县', '渠县', '万源市']), _defineProperty(_areas, '雅安市', ['雨城区', '名山县', '荥经县', '汉源县', '石棉县', '天全县', '芦山县', '宝兴县']), _defineProperty(_areas, '巴中市', ['巴州区', '通江县', '南江县', '平昌县']), _defineProperty(_areas, '资阳市', ['雁江区', '安岳县', '乐至县', '简阳市']), _defineProperty(_areas, '阿坝藏族羌族自治州', ['汶川县', '理县', '茂县', '松潘县', '九寨沟县', '金川县', '小金县', '黑水县', '马尔康县', '壤塘县', '阿坝县', '若尔盖县', '红原县']), _defineProperty(_areas, '甘孜藏族自治州', ['康定县', '泸定县', '丹巴县', '九龙县', '雅江县', '道孚县', '炉霍县', '甘孜县', '新龙县', '德格县', '白玉县', '石渠县', '色达县', '理塘县', '巴塘县', '乡城县', '稻城县', '得荣县']), _defineProperty(_areas, '凉山彝族自治州', ['西昌市', '木里藏族自治县', '盐源县', '德昌县', '会理县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县']), _defineProperty(_areas, '贵阳市', ['南明区', '云岩区', '花溪区', '乌当区', '白云区', '小河区', '开阳县', '息烽县', '修文县', '清镇市']), _defineProperty(_areas, '六盘水市', ['钟山区', '六枝特区', '水城县', '盘县']), _defineProperty(_areas, '遵义市', ['红花岗区', '汇川区', '遵义县', '桐梓县', '绥阳县', '正安县', '道真仡佬族苗族自治县', '务川仡佬族苗族自治县', '凤冈县', '湄潭县', '余庆县', '习水县', '赤水市', '仁怀市']), _defineProperty(_areas, '安顺市', ['西秀区', '平坝县', '普定县', '镇宁布依族苗族自治县', '关岭布依族苗族自治县', '紫云苗族布依族自治县']), _defineProperty(_areas, '铜仁地区', ['铜仁市', '江口县', '玉屏侗族自治县', '石阡县', '思南县', '印江土家族苗族自治县', '德江县', '沿河土家族自治县', '松桃苗族自治县', '万山特区']), _defineProperty(_areas, '黔西南布依族苗族自治州', ['兴义市', '兴仁县', '普安县', '晴隆县', '贞丰县', '望谟县', '册亨县', '安龙县']), _defineProperty(_areas, '毕节地区', ['毕节市', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县']), _defineProperty(_areas, '黔东南苗族侗族自治州', ['凯里市', '黄平县', '施秉县', '三穗县', '镇远县', '岑巩县', '天柱县', '锦屏县', '剑河县', '台江县', '黎平县', '榕江县', '从江县', '雷山县', '麻江县', '丹寨县']), _defineProperty(_areas, '黔南布依族苗族自治州', ['都匀市', '福泉市', '荔波县', '贵定县', '瓮安县', '独山县', '平塘县', '罗甸县', '长顺县', '龙里县', '惠水县', '三都水族自治县']), _defineProperty(_areas, '昆明市', ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡县', '晋宁县', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县', '寻甸回族彝族自治县', '安宁市']), _defineProperty(_areas, '曲靖市', ['麒麟区', '马龙县', '陆良县', '师宗县', '罗平县', '富源县', '会泽县', '沾益县', '宣威市']), _defineProperty(_areas, '玉溪市', ['红塔区', '江川县', '澄江县', '通海县', '华宁县', '易门县', '峨山彝族自治县', '新平彝族傣族自治县', '元江哈尼族彝族傣族自治县']), _defineProperty(_areas, '保山市', ['隆阳区', '施甸县', '腾冲县', '龙陵县', '昌宁县']), _defineProperty(_areas, '昭通市', ['昭阳区', '鲁甸县', '巧家县', '盐津县', '大关县', '永善县', '绥江县', '镇雄县', '彝良县', '威信县', '水富县']), _defineProperty(_areas, '丽江市', ['古城区', '玉龙纳西族自治县', '永胜县', '华坪县', '宁蒗彝族自治县']), _defineProperty(_areas, '思茅市', ['翠云区', '普洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县', '澜沧拉祜族自治县', '西盟佤族自治县']), _defineProperty(_areas, '临沧市', ['临翔区', '凤庆县', '云县', '永德县', '镇康县', '双江拉祜族佤族布朗族傣族自治县', '耿马傣族佤族自治县', '沧源佤族自治县']), _defineProperty(_areas, '楚雄彝族自治州', ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县']), _defineProperty(_areas, '红河哈尼族彝族自治州', ['个旧市', '开远市', '蒙自县', '屏边苗族自治县', '建水县', '石屏县', '弥勒县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县']), _defineProperty(_areas, '文山壮族苗族自治州', ['文山县', '砚山县', '西畴县', '麻栗坡县', '马关县', '丘北县', '广南县', '富宁县']), _defineProperty(_areas, '西双版纳傣族自治州', ['景洪市', '勐海县', '勐腊县']), _defineProperty(_areas, '大理白族自治州', ['大理市', '漾濞彝族自治县', '祥云县', '宾川县', '弥渡县', '南涧彝族自治县', '巍山彝族回族自治县', '永平县', '云龙县', '洱源县', '剑川县', '鹤庆县']), _defineProperty(_areas, '德宏傣族景颇族自治州', ['瑞丽市', '潞西市', '梁河县', '盈江县', '陇川县']), _defineProperty(_areas, '怒江傈僳族自治州', ['泸水县', '福贡县', '贡山独龙族怒族自治县', '兰坪白族普米族自治县']), _defineProperty(_areas, '迪庆藏族自治州', ['香格里拉县', '德钦县', '维西傈僳族自治县']), _defineProperty(_areas, '拉萨市', ['城关区', '林周县', '当雄县', '尼木县', '曲水县', '堆龙德庆县', '达孜县', '墨竹工卡县']), _defineProperty(_areas, '昌都地区', ['昌都县', '江达县', '贡觉县', '类乌齐县', '丁青县', '察雅县', '八宿县', '左贡县', '芒康县', '洛隆县', '边坝县']), _defineProperty(_areas, '山南地区', ['乃东县', '扎囊县', '贡嘎县', '桑日县', '琼结县', '曲松县', '措美县', '洛扎县', '加查县', '隆子县', '错那县', '浪卡子县']), _defineProperty(_areas, '日喀则地区', ['日喀则市', '南木林县', '江孜县', '定日县', '萨迦县', '拉孜县', '昂仁县', '谢通门县', '白朗县', '仁布县', '康马县', '定结县', '仲巴县', '亚东县', '吉隆县', '聂拉木县', '萨嘎县', '岗巴县']), _defineProperty(_areas, '那曲地区', ['那曲县', '嘉黎县', '比如县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '巴青县', '尼玛县']), _defineProperty(_areas, '阿里地区', ['普兰县', '札达县', '噶尔县', '日土县', '革吉县', '改则县', '措勤县']), _defineProperty(_areas, '林芝地区', ['林芝县', '工布江达县', '米林县', '墨脱县', '波密县', '察隅县', '朗县']), _defineProperty(_areas, '西安市', ['新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '蓝田县', '周至县', '户县', '高陵县']), _defineProperty(_areas, '铜川市', ['王益区', '印台区', '耀州区', '宜君县']), _defineProperty(_areas, '宝鸡市', ['渭滨区', '金台区', '陈仓区', '凤翔县', '岐山县', '扶风县', '眉县', '陇县', '千阳县', '麟游县', '凤县', '太白县']), _defineProperty(_areas, '咸阳市', ['秦都区', '杨凌区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '彬县', '长武县', '旬邑县', '淳化县', '武功县', '兴平市']), _defineProperty(_areas, '渭南市', ['临渭区', '华县', '潼关县', '大荔县', '合阳县', '澄城县', '蒲城县', '白水县', '富平县', '韩城市', '华阴市']), _defineProperty(_areas, '延安市', ['宝塔区', '延长县', '延川县', '子长县', '安塞县', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县']), _defineProperty(_areas, '汉中市', ['汉台区', '南郑县', '城固县', '洋县', '西乡县', '勉县', '宁强县', '略阳县', '镇巴县', '留坝县', '佛坪县']), _defineProperty(_areas, '榆林市', ['榆阳区', '神木县', '府谷县', '横山县', '靖边县', '定边县', '绥德县', '米脂县', '佳县', '吴堡县', '清涧县', '子洲县']), _defineProperty(_areas, '安康市', ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳县', '白河县']), _defineProperty(_areas, '商洛市', ['商州区', '洛南县', '丹凤县', '商南县', '山阳县', '镇安县', '柞水县']), _defineProperty(_areas, '兰州市', ['城关区', '七里河区', '西固区', '安宁区', '红古区', '永登县', '皋兰县', '榆中县']), _defineProperty(_areas, '嘉峪关市', ['']), _defineProperty(_areas, '金昌市', ['金川区', '永昌县']), _defineProperty(_areas, '白银市', ['白银区', '平川区', '靖远县', '会宁县', '景泰县']), _defineProperty(_areas, '天水市', ['秦城区', '北道区', '清水县', '秦安县', '甘谷县', '武山县', '张家川回族自治县']), _defineProperty(_areas, '武威市', ['凉州区', '民勤县', '古浪县', '天祝藏族自治县']), _defineProperty(_areas, '张掖市', ['甘州区', '肃南裕固族自治县', '民乐县', '临泽县', '高台县', '山丹县']), _defineProperty(_areas, '平凉市', ['崆峒区', '泾川县', '灵台县', '崇信县', '华亭县', '庄浪县', '静宁县']), _defineProperty(_areas, '酒泉市', ['肃州区', '金塔县', '瓜州县', '肃北蒙古族自治县', '阿克塞哈萨克族自治县', '玉门市', '敦煌市']), _defineProperty(_areas, '庆阳市', ['西峰区', '庆城县', '环县', '华池县', '合水县', '正宁县', '宁县', '镇原县']), _defineProperty(_areas, '定西市', ['安定区', '通渭县', '陇西县', '渭源县', '临洮县', '漳县', '岷县']), _defineProperty(_areas, '陇南市', ['武都区', '成县', '文县', '宕昌县', '康县', '西和县', '礼县', '徽县', '两当县']), _defineProperty(_areas, '临夏回族自治州', ['临夏市', '临夏县', '康乐县', '永靖县', '广河县', '和政县', '东乡族自治县', '积石山保安族东乡族撒拉族自治县']), _defineProperty(_areas, '甘南藏族自治州', ['合作市', '临潭县', '卓尼县', '舟曲县', '迭部县', '玛曲县', '碌曲县', '夏河县']), _defineProperty(_areas, '西宁市', ['城东区', '城中区', '城西区', '城北区', '大通回族土族自治县', '湟中县', '湟源县']), _defineProperty(_areas, '海东地区', ['平安县', '民和回族土族自治县', '乐都县', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县']), _defineProperty(_areas, '海北藏族自治州', ['门源回族自治县', '祁连县', '海晏县', '刚察县']), _defineProperty(_areas, '黄南藏族自治州', ['同仁县', '尖扎县', '泽库县', '河南蒙古族自治县']), _defineProperty(_areas, '海南藏族自治州', ['共和县', '同德县', '贵德县', '兴海县', '贵南县']), _defineProperty(_areas, '果洛藏族自治州', ['玛沁县', '班玛县', '甘德县', '达日县', '久治县', '玛多县']), _defineProperty(_areas, '玉树藏族自治州', ['玉树县', '杂多县', '称多县', '治多县', '囊谦县', '曲麻莱县']), _defineProperty(_areas, '海西蒙古族藏族自治州', ['格尔木市', '德令哈市', '乌兰县', '都兰县', '天峻县']), _defineProperty(_areas, '银川市', ['兴庆区', '西夏区', '金凤区', '永宁县', '贺兰县', '灵武市']), _defineProperty(_areas, '石嘴山市', ['大武口区', '惠农区', '平罗县']), _defineProperty(_areas, '吴忠市', ['利通区', '盐池县', '同心县', '青铜峡市']), _defineProperty(_areas, '固原市', ['原州区', '西吉县', '隆德县', '泾源县', '彭阳县']), _defineProperty(_areas, '中卫市', ['沙坡头区', '中宁县', '海原县']), _defineProperty(_areas, '乌鲁木齐市', ['天山区', '沙依巴克区', '新市区', '水磨沟区', '头屯河区', '达坂城区', '东山区', '乌鲁木齐县']), _defineProperty(_areas, '克拉玛依市', ['独山子区', '克拉玛依区', '白碱滩区', '乌尔禾区']), _defineProperty(_areas, '吐鲁番地区', ['吐鲁番市', '鄯善县', '托克逊县']), _defineProperty(_areas, '哈密地区', ['哈密市', '巴里坤哈萨克自治县', '伊吾县']), _defineProperty(_areas, '昌吉回族自治州', ['昌吉市', '阜康市', '米泉市', '呼图壁县', '玛纳斯县', '奇台县', '吉木萨尔县', '木垒哈萨克自治县']), _defineProperty(_areas, '博尔塔拉蒙古自治州', ['博乐市', '精河县', '温泉县']), _defineProperty(_areas, '巴音郭楞蒙古自治州', ['库尔勒市', '轮台县', '尉犁县', '若羌县', '且末县', '焉耆回族自治县', '和静县', '和硕县', '博湖县']), _defineProperty(_areas, '阿克苏地区', ['阿克苏市', '温宿县', '库车县', '沙雅县', '新和县', '拜城县', '乌什县', '阿瓦提县', '柯坪县']), _defineProperty(_areas, '克孜勒苏柯尔克孜自治州', ['阿图什市', '阿克陶县', '阿合奇县', '乌恰县']), _defineProperty(_areas, '喀什地区', ['喀什市', '疏附县', '疏勒县', '英吉沙县', '泽普县', '莎车县', '叶城县', '麦盖提县', '岳普湖县', '伽师县', '巴楚县', '塔什库尔干塔吉克自治县']), _defineProperty(_areas, '和田地区', ['和田市', '和田县', '墨玉县', '皮山县', '洛浦县', '策勒县', '于田县', '民丰县']), _defineProperty(_areas, '伊犁哈萨克', ['伊宁市', '奎屯市', '伊宁县', '察布查尔锡伯自治县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县']), _defineProperty(_areas, '塔城地区', ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔蒙古自治县']), _defineProperty(_areas, '阿勒泰地区', ['阿勒泰市', '布尔津县', '富蕴县', '福海县', '哈巴河县', '青河县', '吉木乃县']), _defineProperty(_areas, '石河子市', ['']), _defineProperty(_areas, '阿拉尔市', ['']), _defineProperty(_areas, '图木舒克市', ['']), _defineProperty(_areas, '五家渠市', ['']), _areas);
...
var _address = __webpack_require__(128);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("点击选择")]), _vm._v(" "), _c('p', {
    staticClass: " weex-el weex-text",
    staticStyle: {
      "font-size": "0.42667rem"
    },
    attrs: {}
  }, [_vm._v("选中的值为：" + _vm._s(_vm.selectedData.name))]), _vm._v(" "), _c('wx-button', {
    attrs: {
      "height": "80px",
      "width": "450px",
      "borderRadius": "200px",
