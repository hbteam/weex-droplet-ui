...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "weex$tap": function($event) {
        $event.stopPropagation();
        return _vm.handleConfirmConsult($event)
      }
    },
    nativeOn: {
      "weex$tap": function($event) {
