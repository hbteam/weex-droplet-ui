...
// module
exports.push([module.i, "\n.wx-switch[data-v-0eb8f05d] {\n    position: relative;\n    width: 1.38667rem;\n    height: 0.85333rem;\n    border-radius: 0.85333rem;\n    border-width: 1px;\n    border-style: solid;\n    border-color: #ddd;\n    background-color: #d9d9d9;\n}\n.blk[data-v-0eb8f05d] {\n    position: absolute;\n    top: 0.06667rem;\n    left: 0px;\n    z-index: 100;\n    height: 0.69333rem;\n    width: 0.74667rem;\n    background-color: #fff;\n    border-radius: 0.69333rem;\n}\n.switch-core[data-v-0eb8f05d] {\n    position: absolute;\n    top: 0;\n    width: 1.36rem;\n    height: 0.82667rem;\n    background-color: #fdfdfd;\n    border-radius: 0.82667rem;\n}\n\n", "", {"version":3,"sources":["/Users/yangquan/Documents/workspace/github/weex-droplet-ui/packages/wx-switch/index.vue?31935fd8"],"names":[],"mappings":";AASA;IACA,mBAAA;IACA,kBAAA;IACA,mBAAA;IACA,0BAAA;IACA,kBAAA;IACA,oBAAA;IACA,mBAAA;IACA,0BAAA;CACA;AAEA;IACA,mBAAA;IACA,gBAAA;IACA,UAAA;IACA,aAAA;IACA,mBAAA;IACA,kBAAA;IACA,uBAAA;IACA,0BAAA;CACA;AAEA;IACA,mBAAA;IACA,OAAA;IACA,eAAA;IACA,mBAAA;IACA,0BAAA;IACA,0BAAA;CACA","file":"index.vue","sourcesContent":["<template>\n    <div class=\"wx-switch\" \n        :style=\"{'background-color': checked ? checkedColor : '#d9d9d9'}\"\n        @click=\"handleClick\">\n        <text ref=\"switchCore\" class=\"switch-core\"></text>\n        <text class=\"blk\" ref=\"blk\" :style=\"blkStyle\"></text> \n    </div>\n</template>\n<style scoped>\n    .wx-switch {\n        position: relative;\n        width: 104px;\n        height: 64px;\n        border-radius: 64px;\n        border-width: 1px;\n        border-style: solid;\n        border-color: #ddd;\n        background-color: #d9d9d9;\n    }\n    \n    .blk {\n        position: absolute;\n        top: 5px;\n        left: 0px;\n        z-index: 100;\n        height: 52px;\n        width: 56px;\n        background-color: #fff;\n        border-radius: 52px;\n    }\n\n    .switch-core {\n        position: absolute;\n        top: 0;\n        width: 102px;\n        height: 62px;\n        background-color: #fdfdfd;\n        border-radius: 62px;\n    }\n\n</style>\n<script>\n    import mixins from '../utils/mixins';\n    const animation = weex.requireModule('animation');\n\n    export default {\n        mixins:[mixins],\n        props: {\n            value: {\n                type: Boolean,\n            },\n            disabled: {\n                type: Boolean,\n            },\n\n            checkedColor: {\n                type: String,\n                default: '#027FF3',\n            }\n        },\n\n        data () {\n            return {\n                checked: false,\n                blkStyle: {},\n            }\n        },\n\n        created () {\n            this.initBlkStyle();\n        },\n\n        mounted () {\n            this.checked = this.value;\n            this.blkAnimation(true);\n            this.animation(true);\n        },\n\n        methods: {\n            handleClick (e) {\n                this.preventDefault(e);\n                if (this.disabled) return;\n                this.checked = !this.checked;\n                this.animation();\n                this.blkAnimation();\n            },\n\n            animation (isInit = false) {\n                let el = this.$refs.switchCore;\n                let s = this.checked ? '0' : '1';\n                animation.transition(el, {\n                    styles: {\n                        transform: `scale(${s})`\n                    },\n                    duration: isInit ? 0 : 300,\n                    timingFunction: 'linear',\n                    needLayout: false,\n                    delay: 0\n                });\n            },\n\n            blkAnimation (isInit = false) {\n                let el = this.$refs.blk;\n                let x = this.checked ? '42px' : '0px';\n                animation.transition(el, {\n                    styles: {\n                        transform: `translateX(${x})`\n                    },\n                    duration: isInit ? 0 : 300,\n                    timingFunction: 'linear',\n                    needLayout: false,\n                    delay: 0\n                }, () => {\n                    this.$emit('wxChange', this.checked);\n                    this.$emit('input', this.checked);\n                });\n            },\n\n            // android不支持阴影\n            initBlkStyle () {\n                const platform = weex.config.env.platform.toLowerCase();\n                if (platform === 'android') {\n                    this.blkStyle = {\n                        'border-width': '1px',\n                        'border-style': 'solid',\n                        'border-color': '#d9d9d9',\n                    }\n                } else {\n                    this.blkStyle = {\n                        'box-shadow': '0 1px 3px rgba(0,0,0,.4)',\n                    }\n                }\n            }\n        }\n    }\n</script>"],"sourceRoot":""}]);
