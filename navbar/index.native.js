...
__vue_options__.__file = "/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/navbar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-31dcdcfc"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("1产品名称")]), _c('text', {
    staticClass: ["tab-page"]
  }, [_vm._v("2产品介绍")]), _c('text', {
    staticClass: ["tab-page"]
  }, [_vm._v("3申请流程")])]), _c('wx-navbar', {
    attrs: {
      "vif": true,
      "hasBottom": false,
      "animated": true,
  ...
  }, [(_vm.selectedTab.index === 0) ? _c('text', {
    staticClass: ["tab-page"]
  }, [_vm._v("v-if-1")]) : _vm._e(), (_vm.selectedTab.index === 1) ? _c('text', {
    staticClass: ["tab-page"]
  }, [_vm._v("v-if-2")]) : _vm._e(), (_vm.selectedTab.index === 2) ? _c('text', {
    staticClass: ["tab-page"]
