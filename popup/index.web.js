...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-droplet-ui/example/popup/index"] = factory();
	else
		root["npm/weex-droplet-ui/example/popup/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/yangquan/Documents/workspace/github/weex-droplet-ui/example/popup/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-382849de", Component.options)
  } else {
    hotAPI.reload("data-v-382849de", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
    components: {
        WxPopup: _index.WxPopup,
        WxButton: _index.WxButton,
        WxField: _index.WxField
    },
    data: function data() {
        return {
            visibleRight: false,
    ...
    methods: {
        handleRight: function handleRight(visible) {
            this.visibleRight = visible;
        },
        handleLeft: function handleLeft(visible) {
            this.visibleLeft = visible;
        },
        handleTop: function handleTop(visible) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("right")]), _vm._v(" "), _c('wx-button', {
    staticClass: "button",
    attrs: {
      "data-evt-wxClick": ""
    },
  ...
  }, [_vm._v("left")]), _vm._v(" "), _c('wx-button', {
    staticClass: "button",
    attrs: {
      "data-evt-wxClick": ""
    },
  ...
  }, [_vm._v("top")]), _vm._v(" "), _c('wx-button', {
    staticClass: "button",
    attrs: {
      "data-evt-wxClick": ""
    },
  ...
  }, [_vm._v("bottom")]), _vm._v(" "), _c('wx-popup', {
    ref: "wxPopup",
    attrs: {
      "visible": _vm.visibleRight,
      "position": "right",
      "width": "750px",
      "height": "780px",
      "duration": 300,
    ...
    on: {
      "wxChange": _vm.handleRight
    },
    nativeOn: {
      "wxChange": _vm.handleRight
    }
  }, [_c('div', {
    staticClass: "cells weex-ct",
    attrs: {}
  }, [_c('wx-field', {
    attrs: {
      "label": "银行卡号",
    ...
    on: {
      "wxClick": _vm.handleConfirm
    },
    nativeOn: {
      "wxClick": _vm.handleConfirm
    }
  }, [_vm._v("确定")])], 1)]), _vm._v(" "), _c('wx-popup', {
    attrs: {
      "visible": _vm.visibleLeft,
      "position": "left",
      "data-evt-wxChange": ""
    },
    on: {
      "wxChange": _vm.handleLeft
    },
    nativeOn: {
      "wxChange": _vm.handleLeft
    }
    ...
    attrs: {
      "visible": _vm.visibleTop,
      "position": "top",
      "data-evt-wxChange": ""
    },
    on: {
      "wxChange": _vm.handleTop
    },
    nativeOn: {
      "wxChange": _vm.handleTop
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-382849de", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("91f6d4de", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-382849de\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-382849de\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
